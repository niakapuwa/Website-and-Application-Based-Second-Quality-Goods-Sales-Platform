...
include 'dbconnect.php';
	...
	$cariuser = mysqli_fetch_assoc($queryuser);
		...
		if( password_verify($pass, $cariuser['password'])>0 ) {
            ...
            echo "Username atau password Anda salah"; // Passing to JavaScript variable
...
<html>
<head>
<title>nae.thrift.lin - Masuk</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="nae.thrift.lin, by Niken Wardhana" />
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>THE BEST CHOICE OF THRIFT PRODUCTS, GET IT NOW!</p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">nae.thrift.lin</a></h1>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Niken Wardhana, 2021</li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021 Niken Wardhana. All rights reserved</p>
			</div>
		</div>
