...
<head>
    ...
    <title>Admin Panel - nae.thrift.lin</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
									...
									<br>
									<p>Pada halaman admin, Anda dapat menambah kategori produk, mengelola produk, mengelola user dan admin, melihat konfirmasi pembayaran</p>
                                </div>
                            </div>
                        </div>
                    </div>
