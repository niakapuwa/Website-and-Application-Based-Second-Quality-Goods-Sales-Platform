<?php 
    ...
    $grafik = mysqli_query($conn, "SELECT tglorder as tanggal , COUNT(idcart) as total FROM cart where status='Confirmed' GROUP BY tanggal ORDER BY tanggal");
    $grafik_full = array();
...
<head>
    ...
    <title>Kelola Pesanan - nae.thrift.lin</title>
